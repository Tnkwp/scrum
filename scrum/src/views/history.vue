<template>
  ...
  >
    ...
    <div class="flex justify-center">
      <div
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6 w-auto max-w-6xl"
      >
        <div
        ...
        >
          ...
          <div class="flex gap-4 items-center">
            ...
            />
            <div class="flex-1">
              <span class="font-semibold text-gray-800 block break-all">
          ...
          <div class="mt-3 text-sm leading-relaxed text-gray-700 space-y-2 break-words">
            ...
            <template v-else-if="card.type === 'weekly'">
              <p>
                <strong>สิ่งที่ทำวันนี้:</strong><br />{{ card.today || "-" }}
              </p>
